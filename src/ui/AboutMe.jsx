...
function AboutMe() {
  return (
    <section className="flex h-full flex-col-reverse items-center justify-center overflow-auto overflow-hidden bg-[#090909] py-12 pb-40 md:h-screen md:flex-row md:items-center md:justify-center md:px-12 md:py-0">
