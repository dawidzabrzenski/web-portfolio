...
function ProjectsCard({ name, children, href, desc, workInProgress }) {
  ...
  return (
    <div className="flex flex-col rounded-lg bg-[#1B1B1B] md:max-w-[80vw] lg:flex-row">
      <img
        loading="lazy"
        className="min-h-12 rounded-t-lg object-cover object-left md:rounded-l-[0.5rem] md:rounded-r-none lg:max-w-[35vw]"
      ...
      <div className="flex flex-col justify-between px-6 py-4">
        <div>
          <div className="mb-2 flex items-center justify-between">
            <h4 className="text-gradient-sec text-xl font-medium lg:text-3xl">
              {name}
            </h4>
