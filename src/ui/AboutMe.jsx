...
function AboutMe() {
  return (
    <section className="flex flex-col-reverse items-center justify-center overflow-auto bg-[#090909] py-12 pb-10 md:flex-row md:items-center md:justify-center md:px-12">
