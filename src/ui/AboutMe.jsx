...
function AboutMe() {
  return (
    <section className="flex h-full flex-col-reverse items-center justify-center overflow-auto bg-[#090909] py-12 pb-20 md:flex-row md:items-center md:justify-center md:px-12">
